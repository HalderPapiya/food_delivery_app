    ...
    <div class="row">
        <div class="col-md-8 mx-auto">
            <div class="tile">
                ...
                <form action="{{ route('admin.agent.salary.update',$data->id) }}" method="POST" role="form" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
                     ...
                     <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('salary') is-invalid @enderror" type="text" name="salary" id="salary" value="{{ $data->salary }}"/>
                     ...
                     <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('bonus') is-invalid @enderror" type="text" name="bonus" id="bonus" value="{{ $data->bonus }}"/>
                     ...
                     <div class="tile-body">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('total_salary') is-invalid @enderror" type="text" name="total_salary" id="total_salary" value="{{ $data->total_salary }}"/>
