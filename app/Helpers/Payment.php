...
class Payment{
    ...
    */
    public static function _payment($params, $merchant_key, $salt, $env){
        ...
        // argument validation
        $argument_validation = self::_checkArgumentValidation($params, $merchant_key, $salt, $env);
        ...
        // type validation
        $type_validation = self::_typeValidation($postedArray, $salt, $env);
        ...
        // email validation
        $email_validation = self::_email_validation($postedArray['email']);
    ...
    *
    */
    public static function _checkArgumentValidation($params, $merchant_key, $salt, $env){
        $args = func_get_args();
        $argsc = count($args);
        if($argsc !== 4){
            return array(
    ...
    *
    */
    public static function _removeSpaceAndPreparePostArray($params){
        $temp_array = array(
    ...
    *
    */
    public static function _emptyValidation($params, $salt){
        $empty_value = false;
        if(empty($params['key']))
    ...
    *
    */
    public static function _typeValidation($params, $salt, $env){
        $type_value = false;
    ...
    *
    */
    public static function _email_validation($email){
    ...
    *
    */
    public static function _getURL($env){
        $url_link = '';
        switch($env){
            case 'test' :
    ...
    *
    */
    public static function _getHashKey($posted, $salt_key){
    ...
    *
    */
    public static function _curlCall($url, $params_array){
    ...
    *
    */
    public static function response($response_params, $salt_key){
        ...
        $easebuzzPaymentResponse = self::_removeSpaceAndPrepareAPIResponseArray($response_params);

        // empty validation
        $empty_validation = self::_emptyValidation($easebuzzPaymentResponse, $salt_key);
        if(is_array($empty_validation) && $empty_validation['status'] === 0){
            return $empty_validation;
        }
        ...
        $response_result = self::_getResponse($easebuzzPaymentResponse, $salt_key);
    ...
    *
    */
    public static function _removeSpaceAndPrepareAPIResponseArray($response_array){
        $temp_array = array();
    ...
    *
    */
    public static function _getResponse($response_array, $s_key){

        // reverse hash key for validation means response is correct or not.
        $reverse_hash_key = self::_getReverseHashKey($response_array, $s_key);
    ...
    *
    */
    public static function _getReverseHashKey($response_array, $s_key){
